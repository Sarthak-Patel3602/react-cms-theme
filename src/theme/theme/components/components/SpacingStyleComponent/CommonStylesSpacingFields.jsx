    ...
    <>
        ...
        >
            ...
            <ImageField
                ...
                helpText='This is the fallback image shown before the video loads. To add the video link, go to the Content tab.'
                required={false}
                locked={false}
                responsive={true}
                resizable={true}
            ...
            <ColorField
                ...
                visibility={{
                    controlling_field_path: 'groupStyle.groupBackground.enable_overlay_color',
                    operator: 'EQUAL',
        ...
        <FieldGroup
            label="Spacing Section"
            name="groupSpacing"
            display="accordion"
            helpText="Set the spacing for the module"
        >
            <SpacingField
                name="desktopSpacing"
                label="Desktop Spacing"
                helpText="This spacing applies for screens above 1199px"
            />
            <SpacingField
                name="laptopSpacing"
                label="Laptop Spacing"
                helpText="Applies for screens between 992px and 1199px"
            />
            <SpacingField
                name="tabletSpacing"
                label="Tablet Spacing"
                helpText="Applies for screens between 768px and 991px"
            />
            <SpacingField
                name="mobileSpacing"
                label="Mobile Spacing"
                helpText="Applies for screens below 768px"
            />
        </FieldGroup>
